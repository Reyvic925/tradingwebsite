...
create table if not exists traders (
  ...
  synthetic_copiers_current integer not null default 0,
  synthetic_copiers_all_time integer not null default 0,
  synthetic_under_management numeric not null default 0,
