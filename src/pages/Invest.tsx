            ...
            <tbody>
              {investments.map((i) => (
                ...
                >
                  ...
                  <td className={`px-3 py-3 font-mono ${Number(i.earned || 0) >= 0 ? 'text-emerald-400' : 'text-rose-400'}`}>{formatMoney(Number(i.earned || 0))}</td>
            ...
            >
              ...
              <div className="mt-3 grid grid-cols-2 gap-2 text-xs text-stone-400">
                ...
                <div>
                  ...
                  <div className={`mt-1 font-mono ${Number(i.earned || 0) >= 0 ? 'text-emerald-400' : 'text-rose-400'}`}>{formatMoney(Number(i.earned || 0))}</div>
                </div>
