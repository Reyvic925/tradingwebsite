...
export default function InvestmentModal({ investment, plan, onClose, onRefresh }: InvestmentModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-3 backdrop-blur-sm" onClick={onClose}>
      <div
        className="w-full max-w-6xl overflow-hidden rounded-3xl border border-[#2a2e39] bg-gradient-to-br from-[#1a1f2a] to-[#131722] shadow-[0_30px_80px_rgba(0,0,0,0.65)]"
