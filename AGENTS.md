...
Call tools with: `mcporter --config 'C:\Users\DELL\Downloads\apex-prime-broker (2)\config\mcporter.json' call <server>.<tool> key="value"`
...
`C:\Users\DELL\.openclaw-autoclaw\skills/<skill-name>/SKILL.md`
