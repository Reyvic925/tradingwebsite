...
WITH seed (
  ...
  VALUES
    ('Sofia Alvarez', 'Spain', 'https://i.pravatar.cc/300?u=sofia-alvarez', 'Systematic FX trader focused on disciplined entries and controlled downside.', 'FX and gold', ARRAY['EUR-USD', 'GBP-USD', 'XAU-USD'], 'london', 34.80, 0.72, 6.90, 684, 71.40, 11.20, 5, 'Medium', 'Gold', 48, 48, 72, 72000),
